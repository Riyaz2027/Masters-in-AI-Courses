...
class ShoppingCart:
    ...
    def modify_item(self, ItemToPurchase, item_description=None, price=None, quantity=None):
        for item in self.cart_items:
            if item.name == ItemToPurchase:
                ...
                print(f"Item '{ItemToPurchase}' has been modified.")
                return
        print(f"{ItemToPurchase} not found in cart. Nothing modified.")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if choice == 'a':
            ...
            new_quantity = int(input("Enter the new quantity (or leave blank to keep unchanged):\n"))

            # Handle optional description and price
            ...
            cart.modify_item(item_name, item_description=item_description, price=item_price, quantity=new_quantity) 
        elif choice == 'i':
